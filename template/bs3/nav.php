...
if(stripos($_SERVER['REQUEST_URI'],"template")!==false)exit();
	...
	$_SESSION[$OJ_NAME.'_'.'echarts_csrf']=rand();
	if($OJ_ONLINE){
...
<script src="<?php echo $path_fix."template/$OJ_TEMPLATE/echarts.php?echarts_csrf=".$_SESSION[$OJ_NAME.'_'.'echarts_csrf']."&url=".$url."&path_fix=".$path_fix;?>" ></script>
	      <?php }else{?>
